        ...
        <div className="template-about--wrapper">
            <div className="page__component">
                ...
                <section>
                    ...
                    <p className="description">Web development has become extremely versatile in recent years. Improvements to technology have driven huge innovations to the web and allow developers the freedom to create whatever they want. However, these benefits do not come without cost. For every new application, there exists a new technology - to use machine learning, we can run a python server - to write a 2d multiplayer game, we can use the HTML canvas element with websockets in the backend - to make a dashboard with multiple updating components, we can use a front-end component-based framework like React or Vue - etc... </p>
                    <p className="description"><span>tl;dr </span> every new idea yields a brand new library / language / framework that can execute it better than existing solutions and ... now we have so many tools available, it's easy to get lost. Here, you'll answer 2-3 questions about your web-app and I'll provide a starting template as well as documentation for you to get started. </p>
                </section>

                <section>
                    <h2>What do I need to know beforehand?</h2>
                    <p className="description">The first thing you'll be asked is if you need a backend. This is a pretty loaded question and to know if you need a backend, ask yourself these questions:</p>
                    <ul>
                        <li>Do I need to call an API(with a secret API key)?</li>
                        <li>Do I need a database?</li>
                        <li>Do I want to have users login / save unique user data?</li>
